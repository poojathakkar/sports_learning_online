...
INSERT INTO courses (title, description, price, thumbnail, content, tags, user_id) VALUES ('Business Development','tasks and processes to develop and implement growth opportunities', 140.00, 'https://sportslearning.online/uploads/thumbnails/course_thumbnails/course_thumbnail_default_D2UzsVO1.jpg', 'Business development is the creation of long-term value for an organization from customers, markets, and relationships. Business development can be taken to mean any activity by either a small or large organization, non-profit or for-profit enterprise which serves the purpose of ‘developing’ the business in some way.', ARRAY['business','development','growth'], 2);
